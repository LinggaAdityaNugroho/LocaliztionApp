        ...
        <div className="space-y-2 max-w-[220px]">
          <div className="flex flex-wrap gap-1">
            {details.map((d: any, i: number) => (
              <div
                key={i}
                className="bg-indigo-50/50 border border-indigo-100 rounded-md px-2 py-1"
              >
                <p className="text-[11px] font-bold text-indigo-700 leading-tight">
                  {d.alat?.nama_alat}
                </p>
                <p className="text-[9px] text-indigo-400 font-semibold tabular-nums">
                  {d.alat?.kode_tag}
                </p>
              </div>
            ))}
          ...
          <div className="flex items-start gap-1.5 text-[10px] text-slate-500 bg-slate-50 p-1.5 rounded-md border border-slate-100">
            ...
            />
            <span className="italic line-clamp-2">"{tujuan}"</span>
          </div>
        </div>
      );
    },
